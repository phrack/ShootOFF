...
public class TestSessionRecorder {
	...
	public void testOneOfEach() {
		...
		sessionRecorder.recordShot(cameraName, shot, false, false, Optional.of(target1), Optional.of(hitRegionIndex), Optional.empty());
		sessionRecorder.recordShot(cameraName, shot, true, false, Optional.of(target1), Optional.of(hitRegionIndex), Optional.empty());
		sessionRecorder.recordShot(cameraName, shot, false, true, Optional.of(target1), Optional.of(hitRegionIndex), Optional.empty());
	...
	public void testCollapseResizesShotInMiddle() {
		...
		sessionRecorder.recordShot(cameraName, shot, false, false, Optional.of(target1), Optional.of(hitRegionIndex), Optional.of(videoString));
		sessionRecorder.recordTargetResized(cameraName, target1, 13, 20);
		sessionRecorder.recordTargetResized(cameraName, target1, 12, 45);
